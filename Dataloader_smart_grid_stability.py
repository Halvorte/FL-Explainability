...
# Convert stabf column to binary 0 and 1
country_encoder = LabelEncoder()
df['stabf'] = country_encoder.fit_transform(df['stabf'])
...
scaler = MinMaxScaler()
cols_to_normalize = [col for col in df.columns if col not in ['stabf']]
...
train_X = DL_df_train.drop('stabf', axis=1)
train_y = DL_df_train['stabf']
