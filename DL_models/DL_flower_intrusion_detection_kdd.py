...
dataset_name = dataloaders.Dataloader_intrusion_detection_kdd.get_dataset_name()
# Run dataloader file to make data available.
clean_data_df = dataloaders.Dataloader_intrusion_detection_kdd.get_clean_dataset()
X_feature, y_feature = dataloaders.Dataloader_intrusion_detection_kdd.get_data_features()
...
for train_index, test_index in kf.split(clean_data_df):
    ...
    dataloaders.Dataloader_intrusion_detection_kdd.dl_dataloading(df_train, df_test, X_feature, y_feature)
    ...
    #dataloaders.Dataloader_intrusion_detection_kdd.dl_dataloading(df_train, df_val, X_feature, y_feature)
